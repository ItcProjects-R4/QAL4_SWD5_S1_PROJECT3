...
export default function ReceptionAppointments() {
  ...
  const loadStaticData = useCallback(async () => {
    try {
      ...
      console.error(err);
      showToast(err.message || "Failed to load clinic data.", "error");
    }
  }, [showToast]);
  ...
  function validateAppointmentForm(currentForm) {
    ...
    if (!currentForm.doctorId) {
      errors.doctorId = "Please select an available doctor.";
    }
    ...
    if (!currentForm.appointmentDate) {
      ...
      if (Number.isNaN(selectedDate.getTime())) {
        errors.appointmentDate = "Please choose a valid appointment date.";
    ...
    if (currentForm.notes && currentForm.notes.length > 500) {
      errors.notes = "Notes cannot be more than 500 characters.";
    }
  ...
  function mapAppointmentBackendError(message) {
    ...
    if (lowerMessage.includes("patient")) {
      return {
        patientId: message || "Selected patient could not be found.",
      };
    }
    ...
    if (lowerMessage.includes("doctor already has an appointment")) {
      return {
        form:
          "This doctor already has an appointment at this time. Please choose another time.",
      };
    }

    if (lowerMessage.includes("doctor")) {
      return {
        doctorId: message || "Selected doctor is not available.",
      };
    }

    if (lowerMessage.includes("date") || lowerMessage.includes("time")) {
      return {
        appointmentDate: message || "Please choose a valid appointment time.",
      };
    }

    if (lowerMessage.includes("duration")) {
      return {
        duration: message || "Please choose a valid appointment duration.",
      };
    }
    ...
    return {
      form:
        message ||
        "Unable to book appointment. Please review the selected data and try again.",
    };
  }
  ...
  async function handleBookAppointment(e) {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      showToast("Please fix the highlighted fields before booking.", "error");
      return;
    }
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">
              {loading
                ...
                : `${formatLongDate(fromDate)} • ${totalCount} appointments loaded`}
            </p>
          </div>
            ...
            <div className="divide-y divide-slate-100">
              ...
              {!loading &&
                ...
                filteredAppointments.map((a) => {
                  ...
                  const disabled = ["CheckedIn", "Completed", "Cancelled"].includes(
                    status
                  );
                  const patientName =
                  ...
                  return (
                    <div
                      key={a.id}
                      className={`group flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 px-5 sm:px-6 py-5 hover:bg-slate-50 transition-colors ${
                        status === "CheckedIn" ? "bg-emerald-50/40" : ""
                      }`}
                    >
                      <div className="flex items-start sm:items-center gap-5">
                        <div className="text-center w-16 shrink-0">
                          ...
                          <span className="text-[10px] text-slate-400 font-bold uppercase">
                            {formatDateShort(a.appointmentDate)}
                          </span>
                        </div>
          ...
          <aside className="xl:col-span-4 space-y-6">
            <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Appointments loaded from backend filters.
              </p>
            </section>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Schedule a visit by selecting the patient, doctor, and
                    suitable time.
                  </p>
                </div>
              </div>
                ...
                <label className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateAppointmentField("patientId", e.target.value)
                      }
                      className={getAppointmentInputClass(
                ...
                <label className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      value={form.doctorId}
                      onChange={(e) =>
                        updateAppointmentField("doctorId", e.target.value)
                      }
                      className={getAppointmentInputClass(
                ...
                <label>
                  ...
                  <div className="relative">
                    ...
                    <select
                      value={form.duration}
                      onChange={(e) =>
                        updateAppointmentField("duration", e.target.value)
                      }
                      className={getAppointmentInputClass(
                ...
                <label className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      value={form.notes}
                      onChange={(e) =>
                        updateAppointmentField("notes", e.target.value)
                      }
                      placeholder="Optional notes for this appointment"
                      className={`w-full resize-none rounded-2xl border bg-slate-50 py-3 pl-12 pr-4 text-sm font-medium text-slate-800 outline-none transition focus:bg-white focus:ring-4 ${
