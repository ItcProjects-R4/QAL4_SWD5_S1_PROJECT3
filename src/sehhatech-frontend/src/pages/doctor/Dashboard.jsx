    ...
    min-w-[260px]">
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            ...
                            <button
                                ...
                                className="text-primary text-sm font-700 transition-all duration-200
hover:scale-105
active:scale-95
hover:opacity-90"
                            >
                    ...
                    <section className="space-y-5">
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                ...
                                className="text-slate-500 text-xs font-700 transition-all duration-200
hover:scale-105
active:scale-95
hover:opacity-90"
                            >
    ...
    min-w-[260px]"
                ...
                <div className="col-span-12 lg:col-span-4">
                    <section className="bg-white rounded-2xl border border-slate-200 shadow-subtle     transition-all duration-300 ease-out
    hover:-translate-y-1
    hover:shadow-xl
    hover:border-slate-300
