...
export const superadmin = {
    ...
    getMonthlyReports: (month, year) =>
        api.get('/api/SuperAdmin/monthly-reports', { params: { month, year } }).then(r => normalizeKeys(r.data.data ?? r.data)),
    getMonthlyReportsHistory: (tenantId, monthsBack = 12) =>
        api.get('/api/SuperAdmin/monthly-reports/history', { params: { tenantId, monthsBack } }).then(r => normalizeKeys(r.data.data ?? r.data)),
